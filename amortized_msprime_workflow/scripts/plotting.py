...
try:
    ...
    np.save(f"{posteriordir}/{ts_processor}/n_train_{n_train}/default_obs_samples.npy", samples)
    ...
    plt.savefig(f"{posteriordir}/{ts_processor}/n_train_{n_train}/default_obs_corner.png")
except KeyError:
    print(
