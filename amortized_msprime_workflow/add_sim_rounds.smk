...
rule all:
    input:
        expand(os.path.join(datadir, "sim_round_{k}/{i}.trees"), k=list(range(n_rounds, n_rounds+n_extra_rounds)), i=range(n_sims_per_round)),
        ...
        expand(os.path.join(datadir, ts_processor, "sim_round_{k}/x_{i}.npy"), k=list(range(n_rounds, n_rounds + n_extra_rounds)), i=range(n_sims_per_round)),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/posterior_rep_{e}.pkl"), k=list(range(n_rounds, n_rounds + n_extra_rounds)), e=range(n_ensemble)),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/posterior_estimator_rep_{e}.pkl"), k=list(range(n_rounds, n_rounds + n_extra_rounds)), e=range(n_ensemble)),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/inference_rep_{e}.pkl"), k=list(range(n_rounds, n_rounds + n_extra_rounds)), e=range(n_ensemble)),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/ensemble_posterior.pkl"), k=list(range(n_rounds, n_rounds + n_extra_rounds))),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/default_obs_samples.npy"), k=list(range(n_rounds, n_rounds + n_extra_rounds))),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/default_obs_corner.png"), k=list(range(n_rounds, n_rounds + n_extra_rounds))),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/confidence_intervals.png"), k=list(range(n_rounds, n_rounds + n_extra_rounds))),
        expand(os.path.join(posteriordir, ts_processor, "sim_round_{k}/confidence_intervals.npy"), k=list(range(n_rounds, n_rounds + n_extra_rounds)))
